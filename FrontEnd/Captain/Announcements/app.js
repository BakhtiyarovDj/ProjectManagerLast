                    ...
                    if (item.document.file) {
                        ...
                        <li>
                            <div class="document-card my-1">
                                <a href="${item.document.file}"><p class="text-center m-0">${item.document.file.split('/')[5]}</p></a>
                            </div>
                        </li>`;
                    }
                    if (item.document.file2) {
                        html += `
                        <li>
                            <div class="document-card my-1">
                                <a href="${item.document.file2}"><p class="text-center m-0">${item.document.file2.split('/')[5]}</p></a>
                            </div>
                        </li>`;
                    }
                    if (item.document.file3) {
                        html += `
                        <li>
                            <div class="document-card my-1">
                                <a href="${item.document.file3}"><p class="text-center m-0">${item.document.file3.split('/')[5]}</p></a>
                            </div>
                        </li>`;
                    }
                    html += `</ul></div>`;
